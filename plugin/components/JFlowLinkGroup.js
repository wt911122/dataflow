import { inject, watch, onMounted, onUpdated, onUnmounted, toRaw, ref, h, provide } from 'vue';
...
export default function (builder) {
    return {
        ...
        setup(props, { attrs, slots, expose }) {
            ...
            function addToLinkGroupStack(instance) {
                _jflowInstance._linkStack.push(instance);
            }
            provide('addToLinkGroupStack', addToLinkGroupStack);

            function removeFromLinkGroupStack(instance) {
                _jflowInstance.removeFromLinkStack(instance);
            }
            provide('removeFromLinkGroupStack', removeFromLinkGroupStack);
            ...
            const stop2 = watch(() => props.source, (val) => {
                _jflowInstance._jflow.setRenderNodeBySource(toRaw(val).unikey, _jflowInstance);
            });
